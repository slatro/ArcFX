        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            {isAccountBoxOpen && isConnected && (
              <div className="absolute top-full right-0 mt-3 w-64 premium-card border border-white/10 animate-in fade-in slide-in-from-top-2 duration-300">
                <div className="p-5">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-[10px] font-bold text-white/30 uppercase tracking-widest">Connected Wallet</span>
                    <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                  </div>
                  
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/[0.05] mb-6">
                    <span className="text-[11px] font-mono text-white/80 truncate mr-2">{address}</span>
                    <button 
                      onClick={handleCopy}
                  ...
                  <button 
                    onClick={handleLogout}
                    className="w-full py-2.5 rounded-xl bg-red-500/10 hover:bg-red-500/20 text-red-400 text-[10px] font-bold uppercase tracking-[0.2em] transition-all border border-red-500/10"
                  >
                    Disconnect Wallet
                  </button>
                </div>
