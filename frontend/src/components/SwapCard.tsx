...
export const SwapCard = () => {
    ...
    <div className="p-4 rounded-[24px] bg-white/[0.02] border border-white/[0.05]">
      ...
      <div className="flex items-center gap-3">
        <input 
          ...
          readOnly={!isFlipped}
          className={`swap-input !text-xl !py-2 ${!isFlipped ? 'opacity-70' : ''}`}
        />
  ...
  return (
    <div className="premium-card p-6 flex flex-col justify-between h-[600px] relative overflow-hidden max-w-[440px]">
